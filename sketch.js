...
sky=createSprite(displayWidth/10+200,displayHeight/2-20)
 sky.addImage(skyImg);
...
restart.scale=0.75
  ...
  camera.position.x = displayWidth/10+100;
 // camera.position.y = displayHeigth/2-200;
...
function draw() {
 background(255);
  ...
  text("Use arrow keys to move",400,400);
    fill("red")
...
function OB1(){
  ...
  obstacle1.lifetime=900;
  obstacle1G.add(obstacle1);
    
  obstacle1.x=Math.round(random(100,180))
  }
}
  ...
  obstacle2.x=Math.round(random(180,350))
  }
...
function OB3(){
  ...
  obstacle3.x=Math.round(random(120,310))
  }
...
function OB4(){
  ...
  obstacle4.x=Math.round(random(140,280))
  }
 ...
 function fuels(){
  ...
  fuel.x=Math.round(random(310,230))
  }
 }
